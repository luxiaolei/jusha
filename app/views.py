...
def runMapper(intervals=8, overlap=50.0):
    ...
    #  20151220_TL ??? forgot what this is doing here now
	...
	#  20151220_TL "df" (dataframe?) comes in with assignment values in "uploadFile" module in the Controller -> View part
...
"""
20151220_TL
logic: selected feature data array -> divide to bins by np.histogram -> reconstruct ticks as a two-tuple array with (lowerbound, uperbound)
-> loop through this array and record the corresponding index and histogram info as the final return
Controller-View interaction via ajax, involves the model attribute: selected_feature
just for result interrogation
"""
def binGen(array):
    """
    input an array
...
"""
20151220_TL
calculate the statistics of each node/vertex and store for front end displan when mouseover the corresponding node
"""
