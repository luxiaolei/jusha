...
The module ``jushacore.cover`` contains classes for various covers of the filter range. Each such class provides an iterator over the levels and a method ``data_index`` which returns the indices of the data points belonging to a certain level.
'''
import itertools
import numpy as np
import collections
